...
class RepositoryImpl implements Repository {
  ...
  @override
  Future<Either<Failure, MessageIndex>> message() async {
  ...
  @override
  Future<Either<Failure, MessageSend>> messageSend(MessageSendRequest messageSendRequest) async {

    if (await _networkInfo.isConnected) {
      // its connected to internet, its safe to call API
      try {
        final response = await _remoteDataSource.messageSend(messageSendRequest);
